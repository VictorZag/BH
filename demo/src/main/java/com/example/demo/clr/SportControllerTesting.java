...
@Component
@Order(7)
public class SportControllerTesting implements CommandLineRunner {

    private static final String URL = "http://localhost:8080/sports/";

    private final RestTemplate restTemplate;

    @Override
    public void run(String... args) throws Exception {
        System.out.println("++++++SportControllerTesting");
        ...
        Item newItem =Item.builder().name("newItem").itemType(ItemType.SPORTS).build();
        ...
        Item item = restTemplate.getForObject(URL+16, Item.class);
